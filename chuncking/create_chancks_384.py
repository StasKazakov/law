...
async def process_documents():
    ...
    pbar = tqdm(
        total=len(rows), desc="Processing documents into 384 chunks", unit="doc", ncols=100
    )
    ...
    pbar.close()
    print(f"🏁 Generation completed! Total chunks written to 'chunks_384': {total_chunks}")
